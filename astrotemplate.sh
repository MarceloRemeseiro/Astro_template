...
# Nombres fijos
REPOSITORIO="astrotemplate" # Nombre del repositorio en GitHub
CONTAINER_NAME=astrotemplate # Nombre del contenedor Docker
IMAGE_NAME=astrotemplate # Nombre de la imagen Docker
PORT=2000:8080  # Puerto de la aplicación en el contenedor
